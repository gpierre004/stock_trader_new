...
const routes = require('./src/routes');  // Updated path  
const { sequelize, testConnection } = require('./src/infrastructure/database/models');  // Updated path  
const stockController = require('./src/controllers/stockController');  // Updated path  
const watchlistController = require('./src/controllers/watchlistController');  // Updated path  

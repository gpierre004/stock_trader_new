  ...
  try {
    ...
    const transformedData = data.map(row => {
      ...
      return {
        ...
        remaining_shares: row.quantity, // Initialize with full quantity
        current_price: row.purchase_price, // Initialize with purchase price
        cost_basis: row.quantity * row.purchase_price, // Calculate initial cost basis
        comment: row.comment,
        portfolio_id: null // Will be set during creation
      };
    });

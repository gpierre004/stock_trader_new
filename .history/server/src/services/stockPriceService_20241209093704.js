    ...
    for (const company of companies) {
      try {
        ...
        try {
          ...
          // Attempt to log raw API response for debugging
          try {
            ...
            console.error(`[${company.ticker}] Raw fetch error:`, fetchError.message);
          }

          // Rethrow the original error to maintain existing error handling
          throw error;
        }
        ...
        console.error(`[${company.ticker}] Error processing daily price:`, {
          message: error.message,
          name: error.name,
          stack: error.stack
        });

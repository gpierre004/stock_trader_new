...
app.use(helmet());
app.use(cors({
    origin: ['http://localhost:3001', 'http://localhost:5173', 'http://frontend'], // Allow frontend container
...
const startServer = async () => {  
    ...
    try {  
        ...
        MaintenanceJobs.initializeJobs();
        ...
        server.listen(PORT, '0.0.0.0', () => {  // Added host binding
            ...
            console.log('🔄 Company sync: daily at midnight ET');
            console.log('=================================');
        });
    } catch (error) {  

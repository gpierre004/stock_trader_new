            ...
            <CardContent>
              ...
              <Box mb={2}>
                ...
                <Typography variant="h6">
                  {new Intl.NumberFormat().format(data.tradingVolume)}
                </Typography>
              </Box>
              <Box>
                <Typography variant="subtitle2" color="text.secondary" gutterBottom>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                  <Typography 
                    variant="h6"
                    sx={{ color: getVolatilityColor(data.volatilityIndex) }}
                  >
                    {data.volatilityIndex.toFixed(2)}
                  </Typography>
                  <LinearProgress 
                    variant="determinate" 
                    value={Math.min((data.volatilityIndex / 30) * 100, 100)}
                    sx={{ 
                      flexGrow: 1,
                      height: 8,
                      borderRadius: 4,
                      ...
                      '& .MuiLinearProgress-bar': {
                        backgroundColor: getVolatilityColor(data.volatilityIndex),
                        borderRadius: 4
                      }
                    }}
                  />
